...
export default function Banner(prop) {
  return (
    <div className='mt-5 pt-2 position-relative banner-container'>
      <a href='#' className='cart-icon z-3 display-1 text-danger position-absolute hover-scale'><i className="bi bi-cart4"></i></a>
